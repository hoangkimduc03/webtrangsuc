app.controller("summary-ctrl", function ($scope, $http, $location, $filter) {
  ...
  $scope.initialize = function () {
    ...
    $http.get("/rest/summary/secondRow").then((resp) => {
      ...
      var lineRevenueChart = document
        .getElementById("myLineChartRevenue")
        .getContext("2d");
      ...
      var barChartSoldByType = document
        .getElementById("myBarChartSoldByType")
        .getContext("2d");
    ...
    $http.get("/rest/summary/thirdRow").then((resp) => {
      ...
      var pieChart = document
        .getElementById("myBarChartProductByCateAvailable")
        .getContext("2d");
      ...
      var barChartAvailableRate = document
        .getElementById("myBarChartAvailableRate")
        .getContext("2d");
    ...
    $http.get("/rest/summary/fourthRow").then((resp) => {
      ...
      var barChartTop10Product = document
        .getElementById("myBarChartTop10Product")
        .getContext("2d");
